...
@Entity
@Table(name = "business_process_owner")
...
public class ProcessOwner {
    ...
    @Column(name = "business_process_owner_name", nullable = false, length = 255)
    private String name;

    @Column(name = "business_process_owner_position_id", nullable = false)
